...
export const Icon = (props) => <_icon style={[props.onClick && {cursor:'pointer'},props.style ]} onPress={props.onClick} {...props} />

export const A_icon = (props) => <Aicon style={[props.onClick && {cursor:'pointer'},props.style ]} onPress={props.onClick} {...props} />

export const M_icon = (props) => <Micon style={[props.onClick && {cursor:'pointer'},props.style ]} onPress={props.onClick} {...props} />

export const Mc_icon = (props) => <Mcicon style={[props.onClick && {cursor:'pointer'},props.style ]} onPress={props.onClick} {...props} />
